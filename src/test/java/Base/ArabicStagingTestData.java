...
public class ArabicStagingTestData implements TestData{
    ...
    public String getInputCourseNameText() {
        return "تست اتوماشن لا احد يحذفه";
    }
    @Override
    ...
    public String getTheDisplayedCourseDescriptionText() {
        return "كورس تست اتوماشن ممتع وجميل ";
    }
