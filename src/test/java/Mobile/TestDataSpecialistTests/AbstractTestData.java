...
public interface AbstractTestData {
    String getMainTextInWelcomeScreen();
    String getDescriptionTextInWelcomeScreen();
    ...
    String getRegisterTextInSignUpScreen();
    String getHaveAccountTextInSignUpScreen();
    String getLoginLinkedTextInSignUpScreen();
    String getBottomBarTextInSignUpScreen();
